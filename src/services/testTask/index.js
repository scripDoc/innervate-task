...
const serviceConfig = configApi.get('externalTestTaskService');
...
export default oncePerServices(function (services) {
    ...
    async _serviceStart() {
      if (this._enabled && this._importEnabled) {
        this._timerId = setInterval(() => {
          return console.info(`test-task service is alive`);
  ...
  return new (require('../../common/services').Service(services)(TestTaskService))(name, mergedConfig);
});
